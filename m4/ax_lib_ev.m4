...
# DESCRIPTION
#
#   Checks for libev mimicking pkg-config's way of doing things
#   for as long as upstream doesn't provide a .pc file.
#   If successful and provided expand ACTION-IF-FOUND, otherwise
#   expand ACTION-IF-NOT-FOUND, or, if omitted, error out like
#   pkg-config does.
#
